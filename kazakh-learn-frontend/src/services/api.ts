...
export const userPreferencesAPI = {
  ...
  async updateQuizWordCount(count: number): Promise<UserPreferences> {
    return await this.updatePreferences({ quiz_word_count: count });
  },

  // Get quiz settings
  async getQuizSettings(): Promise<{ quiz_word_count: number }> {
